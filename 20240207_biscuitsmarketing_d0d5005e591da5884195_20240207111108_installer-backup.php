...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240207_biscuitsmarketing_d0d5005e591da5884195_20240207111108_archive.zip';
        const ARCHIVE_SIZE       = '204890896';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'd0d5005-07111108';
        const SECONDARY_PACKAGE_HASH = 'a0d8556-07111108';
